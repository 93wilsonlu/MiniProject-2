...
#include "GhostBullet.hpp"
#include "Scene/PlayScene.hpp"
#include "Engine/Point.hpp"

class Turret;

GhostBullet::GhostBullet(Engine::Point position, Engine::Point forwardDirection, float rotation, Turret* parent) :
	Bullet("play/ghost_pink.png", 600, 15, position, forwardDirection, rotation - ALLEGRO_PI / 2, parent) {
}


void GhostBullet::Update(float deltaTime) {
	if (!Target) {
...
void GhostBullet::OnExplode(Enemy* enemy) {
